...
import mainnetDistributors from '../config/mainnet/distributors.json'
import testnetChains from '../config/testnet/chains.json'
import testnetAssets from '../config/testnet/assets.json'
import testnetDistributors from '../config/testnet/distributors.json'
...
export const getDistributors = () => toArray(NETWORK === 'testnet' ? testnetDistributors : mainnetDistributors)