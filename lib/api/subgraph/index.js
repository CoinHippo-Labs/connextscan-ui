...
const analytic_subgraphs = {
  ...
  1284: 'https://api.thegraph.com/subgraphs/name/connext/nxtp-moonriver-v1-analytics',
  1285: 'https://connext.bwarelabs.com/subgraphs/name/connext/nxtp-moonbeam-v1-analytics',
...
export const daily = async params => {
  ...
  while (hasMore) {
    ...
    let response, error, time_spent_seconds, start_time = moment(), i = 0
