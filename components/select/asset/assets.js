...
import { getChainData, getContractData } from '../../../lib/object'
...
export default (
  ...
  const { chains, assets, pool_assets, pools } = useSelector(state => ({ chains: state.chains, assets: state.assets, pool_assets: state.pool_assets, pools: state.pools }), shallowEqual)
