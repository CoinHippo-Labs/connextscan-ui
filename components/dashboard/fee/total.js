          ...
          <div className="text-center py-6">
            <div className="space-y-2 pt-6 pb-3">
              <div className="uppercase text-4xl font-extrabold">
                {currency_symbol}
                {number_format(total_fee, total_fee > 100000 ? '0,0.00a' : total_fee > 10000 ? '0,0' : '0,0.00')}
              </div>
            ...
            {top_chains_by_fee?.map((c, i) => (
              ...
              >
                ...
                <span className="uppercase font-bold">
                  {currency_symbol}
                  {number_format(c.fee, c.fee > 10000 ? '0,0.00a' : c.fee > 1000 ? '0,0' : '0,0.00')}
                </span>
              </div>
            ))}
          </div>
